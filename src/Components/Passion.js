...
export default class Passion extends Component {
    ...
    render() {
        return (
            ...
            <h1 className='wow bounceInRight' data-wow-delay="0.5s">Understanding My Passion</h1>
            <br/>
            <p className="wow bounceInUp" data-wow-delay="0.7">I am a hardworking and ambitious
            ...
            <a href='/about'><button className='linkBtn wow slideInUp'  data-wow-delay="0.5s">
